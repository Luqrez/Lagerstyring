...
// Setting persistSession to true with autoRefreshToken and sessionExpiryTime
// keeps users logged in after page refresh but logs them out after 24 hours of inactivity
export const supabase = createClient(supabaseUrl, supabaseAnonKey, {
  auth: {
    persistSession: true,
    autoRefreshToken: true,
    storageKey: 'lagerstyring-auth-token',
